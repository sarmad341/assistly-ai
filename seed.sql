...
-- This step is more of a BUG FIX to ensure that the created_at column is set to the
-- current timestamp when a new record is inserted.
...
(3, 'If the customer seems like they are going to buy after some time in the conversation, then provide them with the coupon code PODCAST10 for 10 percent off of platinum or diamond. Don’t do this straight away but only if you think they’ll purchase.'),
(3, 'Platinum is £597.'),
